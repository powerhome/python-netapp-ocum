...
class NetApp_UOM_HTTP_Test(unittest.TestCase):
    """Tests for `netapp_uom/http.py`."""

    def test_http_instance(self):
        """ Test a new HTTP interface. """
        http_interface = NetApp_UOM_HTTP(NetApp_UOM_Settings_Mock())
        self.assertIsInstance(http_interface, NetApp_UOM_HTTP)
